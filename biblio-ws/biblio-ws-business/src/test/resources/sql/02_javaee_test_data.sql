...
INSERT INTO `exemplaire` VALUES (16,14,NULL),(17,15,NULL),(18,15,NULL),(23,22,NULL),(24,22,NULL);
...
INSERT INTO `pret` VALUES (19,13,17,'2018-12-12','2021-01-09'),(20,13,16,'2018-12-12','2019-01-09');
/*!40000 ALTER TABLE `pret` ENABLE KEYS */;
UNLOCK TABLES;


UPDATE exemplaire SET pret_id = 20 WHERE id = 16;
UPDATE exemplaire SET pret_id = 19 WHERE id = 17;
