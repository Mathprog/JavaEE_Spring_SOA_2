...
public class ServiceImplTest {
   ...
   @Test
    ...
    public void reservarion_UsaCasesTests(){
        ...
        ouvrage.setReservations(new HashSet<>(this.reservationService.findAllByOuvrage(ouvrage)));s
        ...
        Reservation nextReservationUpdated = this.reservationService.deleteAndUpdateDateLimiteNextResa(reservation, ouvrage);
